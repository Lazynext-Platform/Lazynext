...
const startupDir = await mkdtemp(join(tmpdir(), 'lazynext-env-roundtrip-'));
...
const MODEL_ROUTING_NAMES = [
  ...
  'GEMINI_IMAGE_MODEL', 'GEMINI_TRANSCRIPTION_MODEL', 'GCP_PROJECT_ID', 'GCP_REGION', 'IMAGE_BASE_URL', 'GEMINI_BASE_URL',
  ...
  'LAZYNEXT_SKILLS_DIR', // User skill files directory (''=~/.lazynext/skills)
