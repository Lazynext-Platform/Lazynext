...
async function beginAppliedSession(context: SessionVerifierContext): Promise<AppliedSession> {
  const client = await targetClient(context, 'lazynext-mcp-manual-applied');
...
async function verifyCrossOwnerRejection(
  ...
  const intruder = await targetClient(context, 'lazynext-mcp-session-intruder');
...
async function beginOwnedDiscard(
  ...
  const client = await targetClient(context, 'lazynext-mcp-discard-owner');
...
async function beginRejectedSession(context: SessionVerifierContext): Promise<AppliedSession> {
  const client = await targetClient(context, 'lazynext-mcp-manual-rejected');
...
async function beginStaleDiscard(
  ...
  const client = await targetClient(context, 'lazynext-mcp-stale-discard-owner');
