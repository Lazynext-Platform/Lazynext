...
export function resolveRenderConcurrency({
  ...
  override = process.env.LAZYNEXT_RENDER_CONCURRENCY,
} = {}) {
...
export function remotionHardwareAcceleration(codec, {
  ...
  disabled = /^(?:1|true|yes)$/i.test(process.env.LAZYNEXT_DISABLE_HARDWARE_ENCODING ?? ''),
  encoder,
} = {}) {
...
export function h264FfmpegOverride(encoder, {
  vaapiDevice = process.env.LAZYNEXT_VAAPI_DEVICE,
} = {}) {
