...
const mission = [
  ...
  { icon: Globe, title: 'Global-First', body: 'Built for teams worldwide with transparent USD pricing, Gumroad payments, and design for the 1000+ startups launching every year.' },
]
