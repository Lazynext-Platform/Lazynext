    ...
    <div className="min-h-screen bg-slate-950 text-slate-50">
      ...
      <header className="border-b border-slate-900">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-4 md:px-8">
          ...
          <Link href="/sign-up" className="rounded-lg bg-brand px-3 py-1.5 text-xs font-semibold text-brand-foreground hover:bg-brand-hover transition-colors">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 md:px-8 md:py-16">
        ...
        <div className="mt-16 rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-6 md:p-8">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Link href="/sign-up" className="inline-flex items-center rounded-lg bg-brand px-4 py-2 text-sm font-semibold text-brand-foreground hover:bg-brand-hover transition-colors">
              Start free →
            </Link>
