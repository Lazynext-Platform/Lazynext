      ...
      {view === 'list' ? (
        <>
          ...
          <div className="mt-4 space-y-3">
            {filtered.map((auto) => (
              <div key={auto.id} className={cn('flex items-center justify-between rounded-xl border border-slate-800 bg-slate-900 p-4 transition-all cursor-pointer hover:border-slate-700', !auto.active && 'opacity-70')} onClick={() => { setSelectedId(auto.id); setView('builder') }}>
