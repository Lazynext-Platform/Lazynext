...
TOOL_REGISTRY: list[ToolDefinition] = [
    ...
    {
        "name": "add_clip",
        "description": "Add a media clip (video, audio, image, or text) to a timeline track.",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "split_clip",
        "description": "Split a clip at the given timecode, creating two clips.",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string"},
                "kind": {"type": "string", "enum": ["video", "audio", "text", "effect"]},
            },
            "required": ["kind"],
        },
    },
    ...
    {
        "name": "reorder_track",
        "description": "Change the vertical stacking order of a track.",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "set_clip_speed",
        "description": "Adjust playback speed of a clip (0.25x - 4x).",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "type": {
                    "type": "string",
                    "enum": [
                        "dissolve", "wipe", "slide", "fade",
                        "zoom", "push", "dip_to_color",
                    ],
                },
                "duration": {"type": "number"},
            },
    ...
    {
        "name": "add_keyframe",
        "description": "Add a keyframe to a clip property (position, scale, rotation, opacity).",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Add a text overlay (lower-third, title, or caption).",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
                "text": {"type": "string"},
                "style": {"type": "string", "enum": ["lower_third", "title", "caption", "subtitle"]},
                "start": {"type": "number"},
                "end": {"type": "number"},
                "font": {"type": "string"},
                "size": {"type": "number"},
    ...
    {
        "name": "remove_silence",
        "description": "Detect and remove silent segments from an audio/video clip.",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "detect_scenes",
        "description": "Run scene-detection on a video clip and return cut points.",
        "category": "editing",
        "parameters": {
            "type": "object",
            "properties": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "preset": {
                    "type": "string",
                    "enum": [
                        "voice_enhance", "bass_boost", "treble_reduce",
                        "podcast", "vocal_presence", "custom",
                    ],
                },
    ...
    {
        "name": "apply_de_esser",
        "description": "Apply de-essing to reduce sibilance (harsh 's' sounds).",
        "category": "audio",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Measure integrated, short-term, and momentary LUFS of a clip.",
        "category": "audio",
        "parameters": {
            "type": "object",
            "properties": {"clip_id": {"type": "string"}},
    ...
    {
        "name": "auto_duck",
        "description": "Automatically duck background music under dialogue.",
        "category": "audio",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "replace_audio",
        "description": "Replace a video clip's audio with a different audio source.",
        "category": "audio",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "load_vst",
        "description": "Load a VST3 plugin and apply it to an audio clip or track.",
        "category": "audio",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "generate_tts",
        "description": "Generate text-to-speech audio and place it on the timeline.",
        "category": "audio",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Transcribe speech from an audio/video clip to text.",
        "category": "audio",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "apply_lut",
        "description": "Apply a LUT (Look-Up Table) to a video clip.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Adjust white balance (temperature and tint) of a video clip.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "color_wheels",
        "description": "Adjust lift, gamma, and gain via three-way colour wheels.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
                "clip_id": {"type": "string"},
                "lift": {"type": "object", "properties": {"r": {}, "g": {}, "b": {}}},
                "gamma": {"type": "object", "properties": {"r": {}, "g": {}, "b": {}}},
                "gain": {"type": "object", "properties": {"r": {}, "g": {}, "b": {}}},
            },
            "required": ["clip_id"],
        },
    },
    {
        "name": "curves",
        "description": "Apply a custom RGB / luma curve to a clip.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Convert between colour spaces (Rec.709, Rec.2020, DCI-P3, ACES).",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "auto_color",
        "description": "Auto-balance exposure, contrast, and white balance.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {"clip_id": {"type": "string"}},
    ...
    {
        "name": "match_color",
        "description": "Match the colour grade of one clip to another (reference).",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "add_vignette",
        "description": "Add a vignette effect (darkened edges) to a clip.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Add film-grain texture to a clip.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Set the blend mode for a clip (17 blend modes available).",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "adjust_opacity",
        "description": "Adjust the opacity of a clip.",
        "category": "color",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "export_video",
        "description": "Export the timeline to a video file (MP4, MOV, ProRes, DCP, etc.).",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
                "format": {"type": "string", "enum": ["mp4", "mov", "prores", "dcp", "webm", "gif"]},
                "codec": {"type": "string"},
    ...
    {
        "name": "export_audio",
        "description": "Export the audio mixdown (WAV, MP3, AAC, FLAC).",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "export_frame",
        "description": "Export a single still frame as an image (PNG, JPEG, TIFF, EXR).",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
                "at_time": {"type": "number"},
                "format": {"type": "string", "enum": ["png", "jpeg", "tiff", "exr", "webp"]},
                "output_path": {"type": "string"},
            },
    ...
    },
    {
        ...
        "description": "Export a range of frames as an image sequence.",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "render_preview",
        "description": "Render a low-res preview of the current timeline.",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "queue_render",
        "description": "Queue a render job on the remote render farm.",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Generate a social-media-optimised cut (9:16, 1:1, 4:5).",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Publish the exported video to YouTube, TikTok, Instagram, or Vimeo.",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
                "platform": {"type": "string", "enum": ["youtube", "tiktok", "instagram", "vimeo"]},
                "title": {"type": "string"},
    ...
    },
    {
        ...
        "description": "Generate a C2PA content-authenticity manifest for the export.",
        "category": "export",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    # ── AI (12 tools) ──────────────────────────────────────────────────
    {
        ...
        "description": "Process a natural-language editing intent through the LLM pipeline.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "generate_video",
        "description": "Generate AI video from a text prompt via the generative-studio service.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "generate_audio",
        "description": "Generate AI audio (music, sound effects) from a text prompt.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "auto_caption",
        "description": "Automatically generate captions from speech-to-text and overlay them.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "auto_chapter",
        "description": "Automatically detect chapter markers using scene and topic analysis.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "auto_tag",
        "description": "Generate content tags, keywords, and hashtags from the timeline content.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "summarize_clip",
        "description": "Generate a natural-language summary of a clip's content.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {"clip_id": {"type": "string"}},
    ...
    {
        "name": "smart_reframe",
        "description": "AI-powered auto-reframing that tracks subjects when changing aspect ratios.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Detect and remove filler words (um, uh, like) from audio.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
                "clip_id": {"type": "string"},
                "aggressiveness": {"type": "string", "enum": ["gentle", "normal", "aggressive"]},
            },
            "required": ["clip_id"],
        },
    },
    {
        ...
        "description": "AI-powered background removal from a video clip.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "upscale",
        "description": "AI upscaling (2x, 4x) of a low-resolution clip.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    },
    {
        ...
        "description": "Fill a region or gap in the timeline using AI inpainting.",
        "category": "ai",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "name": "save_project",
        "description": "Save the current project state (creates a named snapshot).",
        "category": "project",
        "parameters": {
            "type": "object",
    ...
    {
        "name": "import_media",
        "description": "Import media from a URL or local path into the project.",
        "category": "project",
        "parameters": {
            "type": "object",
            "properties": {
