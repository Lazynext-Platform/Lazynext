...
const TOOL_REGISTRY = [
    ...
    },
    {
        ...
        description: "Add a text overlay (lower-third, title, or caption) at the given time range.",
        category: "editing",
        parameters: {
            type: "object",
            properties: {
    ...
    {
        name: "auto_color",
        description: "Auto-balance exposure, contrast, and white balance using scene analysis.",
        category: "color",
        parameters: {
            type: "object",
            properties: { clip_id: { type: "string" } },
    ...
    {
        name: "save_project",
        description: "Save the current project state (auto-saved via CRDT, explicit save creates a named snapshot).",
        category: "project",
        parameters: {
            type: "object",
