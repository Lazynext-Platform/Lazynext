export const DESKTOP_UPDATE_CHANNELS = {
  state: 'lazynext:update-state',
  getState: 'lazynext:update-get-state',
  check: 'lazynext:update-check',
  download: 'lazynext:update-download',
  install: 'lazynext:update-install',
} as const;
