...
export type ModelPackCapability =
  ...
  | 'Music similarity'
  | 'Visual semantic vectors'
  | 'Chinese visual retrieval'
...
export const MODEL_PACKS = [
  {
    id: 'rhythm-lite',
    label: 'Rhythm analysis lite pack',
    description: 'Analyze beats, downbeats, tempo, time signature, and beat energy locally.',
    ...
    capabilities: ['Beat tracking', 'Downbeat tracking', 'BPM & time signature', 'Beat energy'],
    files: [
      {
        path: 'beat_this.onnx',
  ...
  },
  {
    ...
    label: 'Music semantic lite pack',
    description: 'Generate music semantic vectors on-device for retrieval and similarity matching.',
    ...
    capabilities: ['Music semantic vectors', 'Music similarity'],
    files: [
      {
        path: 'config.json',
        sizeBytes: 699,
  ...
  },
  {
    ...
    label: 'Visual semantic lite pack',
    description: 'Generate visual and text vectors on-device for semantic retrieval and duplicate shot detection.',
    modelId: 'Xenova/chinese-clip-vit-base-patch16',
    revision: 'f26904860903e70e050b8f48255e5f48401816e9',
    license: 'Apache-2.0',
    sizeBytes: 178_225_758,
    recommendedMemoryBytes: 2 * GIB,
    capabilities: ['Visual semantic vectors', 'Chinese visual retrieval', 'Duplicate shot detection'],
    files: [
      {
        path: 'config.json',
        sizeBytes: 844,
