...
export const AGENT_PATH_IMPORT_CHANNEL = 'lazynext:agent-path-import';

export const DIRECTORY_IMPORT_CHANNELS = {
  start: 'lazynext:directory-import-start',
  activate: 'lazynext:directory-import-activate',
  acknowledge: 'lazynext:directory-import-acknowledge',
  stop: 'lazynext:directory-import-stop',
  imported: 'lazynext:directory-import-file',
} as const;
