...
export const ASR_MODELS: readonly AsrModelEntry[] = [
  {
    ...
    label: 'Whisper Tiny', sizeLabel: '~176MB', language: 'ZH / EN', note: 'Fastest and most lightweight; suitable for low-spec devices; average recognition accuracy.',
  },
  {
    ...
    label: 'Whisper Base', sizeLabel: '~351MB', language: 'ZH / EN', note: 'Lightweight and balanced; suitable for everyday voiceover; timestamped transcription is faster.',
  },
  {
    ...
    label: 'Whisper Small', sizeLabel: '~1.0GB', language: 'ZH / EN', note: 'Recommended: balanced Chinese/English recognition, Simplified Chinese output, stable word-level timestamps.',
  },
  {
    ...
    label: 'Whisper Medium', sizeLabel: '~743MB', language: 'ZH / EN', note: 'Highest accuracy but larger size and slower transcription; choose when quality matters most.',
  },
];
