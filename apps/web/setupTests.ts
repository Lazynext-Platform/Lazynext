...
try {
	...
	console.error("Failed to init WASM in tests", e);
}
...
globalThis.AggregateError = class extends OriginalAggregateError {
	constructor(errors: Iterable<any>, message?: string, options?: ErrorOptions) {
...
globalThis.OffscreenCanvas = class OffscreenCanvas {
	constructor() {}
	getContext() {
		return globalThis.HTMLCanvasElement.prototype.getContext.call(
			this,
			"2d" as any,
		);
	}
