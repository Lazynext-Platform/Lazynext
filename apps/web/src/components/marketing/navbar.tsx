    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between bg-neutral-900/40 backdrop-blur-xl border border-neutral-800/50 rounded-2xl px-6 py-3 shadow-2xl">
        ...
        <div className="flex items-center gap-4">
          <Link href="/login" className="px-6 py-2 bg-white/5 hover:bg-white/10 text-white font-medium rounded-xl border border-white/10 transition-colors">
            Login
          </Link>
          <Link href="/dashboard" className="px-6 py-2 bg-[#00e5ff] hover:bg-[#00b3cc] text-black font-semibold rounded-xl shadow-[0_0_15px_rgba(0,229,255,0.4)] transition-all">
            Get Started
          </Link>
        </div>
      </div>
