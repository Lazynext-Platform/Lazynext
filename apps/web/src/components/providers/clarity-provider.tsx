/**
 * Microsoft Clarity provider — session recordings, heatmaps, click maps.
 * Free forever, unlimited. No API key loaded until paired in Clarity dashboard.
 *
 * @module components/providers/clarity-provider
 */
