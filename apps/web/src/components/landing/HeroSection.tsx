	...
	return (
		<section className="relative min-h-[90vh] overflow-hidden bg-[var(--bg-main)] flex flex-col justify-center items-center transition-colors duration-300">
			...
			<div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
				{/* Top Status Pill */}
				<div 				className="mb-8 inline-flex items-center gap-2 rounded-full border border-[var(--border-glass)] dark:border-border bg-[var(--bg-panel)]/50 dark:bg-hover px-4 py-1.5 text-sm font-medium text-[var(--text-secondary)] dark:text-foreground backdrop-blur-xl transition-colors hover:bg-[var(--bg-hover)] dark:hover:bg-glass animate-in fade-in slide-in-from-bottom-4 duration-700">
				...
				{/* Main Headline */}
				<h1 				className="text-5xl font-extrabold tracking-tighter text-[var(--text-primary)] dark:text-foreground md:text-7xl lg:text-[5.5rem] leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
					The Agentic
					<br />
				...
				{/* Subheadline */}
				<p 				className="mx-auto mt-8 max-w-3xl text-lg text-[var(--text-muted)] dark:text-muted md:text-xl font-light leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
				...
				<div className="mt-8 flex flex-wrap justify-center gap-3 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
					<div className="flex items-center gap-2 rounded-lg border border-[var(--border-glass)] dark:border-border bg-[var(--bg-panel)]/50 dark:bg-hover px-3 py-1.5 text-sm text-[var(--text-secondary)] dark:text-foreground backdrop-blur-sm">
				...
				<div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500">
					<Link
						href="/sign-up"
						className="group relative flex items-center justify-center gap-2 overflow-hidden rounded-xl bg-foreground dark:bg-[var(--text-primary)] px-8 py-4 text-base font-bold text-background dark:text-[var(--bg-main)] transition-transform hover:scale-105 hover:bg-[var(--bg-panel)] dark:hover:bg-[var(--bg-hover)]"
					>
					...
					<Link
						href="/docs"
						className="flex items-center justify-center rounded-xl border border-[var(--border-glass)] dark:border-border bg-[var(--bg-panel)]/50 dark:bg-hover px-8 py-4 text-base font-medium text-[var(--text-primary)] dark:text-foreground backdrop-blur-sm transition-colors hover:bg-[var(--bg-hover)] dark:hover:bg-glass"
					>
