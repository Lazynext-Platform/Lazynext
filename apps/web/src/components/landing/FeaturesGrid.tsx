...
export function FeaturesGrid() {
	return (
		<section className="relative overflow-hidden bg-background px-4 py-24 transition-colors duration-300">
			<div className="mx-auto max-w-6xl">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:auto-rows-[300px]">
					...
					<div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-panel p-8 border border-border transition-colors hover:border-zinc-300 dark:hover:border-border hover:bg-hover shadow-sm dark:shadow-none">
					...
					<div className="md:col-span-1 md:row-span-2 group relative overflow-hidden rounded-3xl bg-panel p-8 border border-border transition-colors hover:border-zinc-300 dark:hover:border-border hover:bg-hover shadow-sm dark:shadow-none">
						...
						<div className="relative z-10 flex h-full flex-col">
							...
							{/* Example prompt */}
							<div className="mt-auto rounded-xl bg-hover p-4 border border-border font-mono text-xs text-muted shadow-inner overflow-hidden">
								...
								<p className="pl-4 mt-1 text-foreground">
					...
					<div className="md:col-span-1 group relative overflow-hidden rounded-3xl bg-panel p-8 border border-border transition-colors hover:border-zinc-300 dark:hover:border-border hover:bg-hover shadow-sm dark:shadow-none">
						<div className="relative z-10 flex h-full flex-col justify-end">
