...
export function CTASection() {
	return (
		<section className="relative overflow-hidden bg-background px-4 py-32 transition-colors duration-300">
			...
			<div className="relative z-10 mx-auto max-w-3xl text-center">
				<h2 className="text-4xl font-extrabold text-foreground md:text-6xl tracking-tight leading-[1.1]">
					Ready to edit
					<br />
				...
				<div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
					<Link
						href="/sign-up"
						className="group flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-foreground px-8 py-4 text-base font-bold text-background shadow-[0_0_40px_-10px_rgba(0,0,0,0.1)] dark:shadow-[0_0_40px_-10px_var(--accent-glow)] transition-all hover:scale-105 hover:bg-hover"
					>
						Start Editing
					...
					<Link
						href="/sign-up"
						className="flex w-full sm:w-auto items-center justify-center rounded-xl border border-border bg-panel px-8 py-4 text-base font-medium text-foreground backdrop-blur-sm transition-colors hover:bg-hover"
					>
						Create Account
					</Link>
				</div>
