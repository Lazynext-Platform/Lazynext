...
import { Heart, MessageCircle, Share2, Music, Scissors, Play } from 'lucide-react';
...
export function VideoPlayer({ id, url, author, description, songName, likes, comments, isActive }: VideoProps) {
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex flex-col items-center gap-6 pb-4">
            ...
            >
              ...
              <span className="text-white text-xs font-bold">{likes + (isLiked ? 1 : 0)}</span>
            </button>
