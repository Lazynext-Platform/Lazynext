...
export function LumetriScopes({ sourceCanvasRef }: { sourceCanvasRef: React.RefObject<HTMLCanvasElement | null> }) {
  const waveformRef = useRef<HTMLCanvasElement>(null);
  const vectorscopeRef = useRef<HTMLCanvasElement>(null);
  const [activeScope, setActiveScope] = useState<'waveform' | 'vectorscope'>('waveform');
