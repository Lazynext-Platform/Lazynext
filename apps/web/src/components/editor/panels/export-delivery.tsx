					...
					<div>
						...
						<div className="grid grid-cols-3 gap-2">
							<button
								...
								className={`py-2 text-[10px] font-bold rounded border ${format === "mp4" ? "bg-blue-600/20 border-blue-500 text-blue-300" : "bg-zinc-950 border-zinc-800 text-zinc-500"}`}
							>
								H.265 / MP4
							</button>
							<button
								onClick={() => setFormat("mov")}
								className={`py-2 text-[10px] font-bold rounded border ${format === "mov" ? "bg-blue-600/20 border-blue-500 text-blue-300" : "bg-zinc-950 border-zinc-800 text-zinc-500"}`}
							>
								ProRes / MOV
							</button>
							<button
								onClick={() => setFormat("dcp")}
								className={`py-2 text-[10px] font-bold rounded border ${format === "dcp" ? "bg-blue-600/20 border-blue-500 text-blue-300" : "bg-zinc-950 border-zinc-800 text-zinc-500"}`}
							>
								Cinema DCP
							</button>
						</div>
