...
export function isAnalyticsEnabled(config?: AnalyticsConfig): boolean {
	...
	if (typeof window !== "undefined") {
		const envDisabled =
			...
			(typeof process !== "undefined" &&
				(process as any).env?.TWICK_ANALYTICS_ENABLED === "false");
	...
	const envEnabled =
		(typeof window !== "undefined" &&
			(import.meta as any).env?.VITE_TWICK_ANALYTICS_ENABLED === "true") ||
		(typeof process !== "undefined" &&
			(process as any).env?.TWICK_ANALYTICS_ENABLED === "true");
...
export function getPostHogApiKey(config?: AnalyticsConfig): string | undefined {
	...
	return (
		config?.apiKey ||
		(typeof window !== "undefined" &&
			(import.meta as any).env?.VITE_POSTHOG_API_KEY) ||
