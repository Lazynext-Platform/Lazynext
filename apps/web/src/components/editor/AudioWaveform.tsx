export default function AudioWaveform({ width, seed, peaks }: { width: number, seed: string, peaks?: number[] }) {
  const lines = [];
  ...
  return (
    <svg width="100%" height="100%" className="absolute inset-0 pointer-events-none text-white/50" preserveAspectRatio="none">
      {lines}
    </svg>
  );
}
