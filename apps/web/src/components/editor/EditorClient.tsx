				...
				<div className="p-3 border-t border-border bg-background/50">
					<div className="relative group">
						...
						<button
							...
							className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 bg-[var(--accent-primary)] text-background rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
						>
