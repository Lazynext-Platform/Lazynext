...
export const metadata: Metadata = {
	...
	description:
		"Lazynext's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - Lazynext",
		description:
			"Lazynext's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
		...
		>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from Lazynext</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use Lazynext</h2>
				<p>Lazynext is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use Lazynext for client work and paid projects</li>
					<li>Share and distribute videos created with Lazynext</li>
					<li>
						Modify and distribute the Lazynext software (under MIT license)
					</li>
				</ul>
				<p>
					You&apos;re responsible for how you use Lazynext and the content you
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					...
					are optional - you can use Lazynext without them.
				</p>
			</section>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Lazynext does not currently require an account. The service is provided
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because Lazynext is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host Lazynext on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Lazynext is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update Lazynext and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>You can stop using Lazynext at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
