...
export const metadata: Metadata = {
	...
	openGraph: {
		title: "Changelog - Lazynext",
		description: "Every update, improvement, and fix to Lazynext — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in Lazynext">
