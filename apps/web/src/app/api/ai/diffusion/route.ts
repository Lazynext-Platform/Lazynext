...
export async function POST(request: Request) {
  try {
    ...
    console.log(`[API] Dispatching Text-to-Video task to Generative Studio: "${prompt}"`);
    ...
    try {
      ...
      return NextResponse.json({
        success: true,
        message: 'Generated a 5-second 4K video clip via Fallback Mock (Service Offline)',
        clip: mockVideoClip
      });
    }
