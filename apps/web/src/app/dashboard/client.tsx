			...
			<main className="relative z-10 mx-auto max-w-6xl px-6 py-16">
				...
				<div className="mb-16 grid grid-cols-1 md:grid-cols-4 gap-6">
					<div className="glass-panel p-6 flex flex-col relative overflow-hidden group hover:border-[#00e5ff]/50 hover:bg-hover transition-all">
						...
						<div className="text-4xl font-display font-black text-foreground relative z-10">
							{aiCredits.toLocaleString()}
						</div>
						<div className="mt-2 text-sm text-foreground/50 relative z-10">
							Available this month
						</div>
					</div>

					<div className="glass-panel p-6 flex flex-col relative overflow-hidden group hover:border-indigo-500/50 hover:bg-hover transition-all">
						<div className="flex items-center justify-between mb-4 relative z-10">
							<span className="text-foreground/50 text-xs font-bold uppercase tracking-widest font-display">
								Render Node
							</span>
					...
					<div className="glass-panel p-6 flex flex-col relative overflow-hidden group hover:border-emerald-500/50 hover:bg-hover transition-all">
						<div className="flex items-center justify-between mb-4 relative z-10">
							<span className="text-foreground/50 text-xs font-bold uppercase tracking-widest font-display">
								Projects
							</span>
				...
				<section>
					...
					{projects.length === 0 ? (
						<div className="glass-panel p-16 text-center flex flex-col items-center justify-center">
							<div className="w-20 h-20 rounded-full bg-hover flex items-center justify-center mb-6 shadow-inner border border-border">
								<PlayCircle className="w-10 h-10 text-foreground/30" />
							</div>
							<p className="text-2xl font-bold text-foreground mb-2 font-display">
								No projects yet
							</p>
							<p className="text-foreground/50 max-w-md mb-8">
								Your workspace is completely empty. Launch the Agentic AI
								Copilot to generate your first cinematic sequence.
							</p>
							<button
								onClick={handleCreateProject}
								disabled={isCreating}
