...
export function ScriptEditor() {
    ...
    const mockScript = [
        ...
        { id: "sentence_2", text: "CAPTAIN: We are venting oxygen! We need to seal the airlock." },
        { id: "sentence_3", text: "PILOT: I'm trying, but the manual override is jammed!" }
    ];
    ...
    return (
        <div className="p-6 bg-white border border-gray-300 rounded shadow-lg max-w-lg font-serif text-black">
            <h2 className="font-bold text-xl mb-4 border-b pb-2">Screenplay Editor</h2>
