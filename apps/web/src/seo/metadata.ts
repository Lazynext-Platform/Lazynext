...
export const SITE_CONFIG = {
	...
	shortName: "Lazynext",
	description:
		"AI-powered video editing platform. Describe your edit in natural language and watch our multi-model AI agent execute it. 18 AI providers, Rust-powered compositor, 6 platform formats.",
...
export function generateMetadata({
	...
	const fullTitle = title
		...
		: `${SITE_CONFIG.name} — AI Video Editing Platform`;
