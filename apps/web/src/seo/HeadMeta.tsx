...
export function SEOHeadTags() {
	return (
		<>
			...
			<meta name="google-site-verification" content="D2y26t7Jjr7aHDqVUYY4q0WrR8dTn6bVez-8Bqp_P0U" />
			...
			<meta name="DC.description" content="AI-powered video editing with natural language. Multi-model AI agents, Rust compositor, 6 platforms." />
			...
			<meta name="DC.rights" content="Copyright 2025-2026 Lazynext. All rights reserved." />
