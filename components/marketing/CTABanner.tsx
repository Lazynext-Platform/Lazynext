      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="relative overflow-hidden rounded-3xl bg-brand px-8 py-16 text-center md:py-20">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-lg text-lg text-brand-foreground/75">
              Join 1,200+ teams who consolidated their stack and started
              shipping faster.
            </p>
            <Link
              href="/sign-up"
              className="mt-8 inline-flex items-center rounded-xl bg-slate-950 px-8 py-4 text-base font-bold text-brand shadow-lg transition-colors hover:bg-slate-800"
            >
