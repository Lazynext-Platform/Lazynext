...
const sampleMessages: ThreadMessage[] = [
  {
    ...
    time: '3 days ago',
    table: {
      headers: ['Feature', 'Neon', 'Supabase', 'PlanetScale'],
      rows: [
        { cells: [{ value: 'Serverless', type: 'text' }, { value: '✓', type: 'check' }, { value: '✓', type: 'check' }, { value: '✓', type: 'check' }] },
        { cells: [{ value: 'India Region', type: 'text' }, { value: '✓', type: 'check' }, { value: '✗', type: 'x' }, { value: '✗', type: 'x' }] },
        { cells: [{ value: 'Branching', type: 'text' }, { value: '✓', type: 'check' }, { value: '✗', type: 'x' }, { value: '~', type: 'tilde' }] },
        { cells: [{ value: 'Free Tier', type: 'text' }, { value: '0.5 GB', type: 'text' }, { value: '0.5 GB', type: 'text' }, { value: '5 GB', type: 'text' }] },
        { cells: [{ value: 'SQL Flavor', type: 'text' }, { value: 'Postgres', type: 'text' }, { value: 'Postgres', type: 'text' }, { value: 'MySQL', type: 'text' }] },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    initials: 'AP',
    avatarColor: 'bg-indigo-500',
    content: "PlanetScale uses MySQL — our Drizzle queries are Postgres-specific. Migrating would cost us 2+ weeks. Neon's branching lets us create per-PR databases too.",
    time: '2 days ago',
  },
  {
    id: '4',
    ...
    content: 'Makes sense. I agree with Neon. @Priya Sharma what do you think?',
    time: '2 days ago',
  ...
  },
  {
    ...
    initials: 'PS',
    avatarColor: 'bg-emerald-500',
    content: "Alright, let's go with Neon then 👍",
    time: '1 day ago',
