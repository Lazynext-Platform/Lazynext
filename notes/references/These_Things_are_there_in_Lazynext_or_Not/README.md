...
**3. Use it** — say to your AI: _"Use the levea tool to generate 5 viral clips from this video, add captions, reframe vertical."_ The agent picks the tool, fills the prompt; the editor plans → executes → exports.
...
→ For agent-integration details (schemas, async semantics, error handling, plan approval), see **[AGENTS.md](https://github.com/Lazynext-Corporation/openclaw-ai-video-editor/blob/main/AGENTS.md)**.
...
_30+ production-grade animated graphics:_
...
**2. Open-ended goals** — hand the agent a _goal_ instead of a command; it inspects the asset, then proposes a plan:
