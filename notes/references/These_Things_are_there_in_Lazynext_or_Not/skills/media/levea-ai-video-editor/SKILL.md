...
metadata:
  hermes:
    ...
    homepage: https://github.com/Lazynext-Corporation/openclaw-ai-video-editor#readme
---
...
```json
{
	...
	"scene": {
		"_comment": "optional client scene; server-side committed scene wins if newer"
	}
}
```
...
```json
{
	...
	"verificationIssues": [],
	"workingMemory": {
		"_comment": "return this in the next call to resume approval-paused runs"
	}
}
```
