...
export default {
  ...
  mac: {
    ...
    icon: 'assets/branding/lazynext-icon.icns',
  ...
  linux: {
    ...
    icon: 'public/lazynext-icon.png',
    category: 'AudioVideo',
    // Keep the executable name stable for release/linux-unpacked/lazynext and CI smoke tests.
    executableName: 'lazynext',
