...
|---|------|---------|-------|
| 1 | Team | Monthly | $12 |
| 2 | Team | Yearly | $120 (per seat, per year) |
| 3 | Business | Monthly | $24 |
| 4 | Business | Yearly | $240 (per seat, per year) |
...
**3.** Fill in:
   ...
   - **Price:** enter the price from the table above (e.g. `12` for Team Monthly)
   - **Recurrence:** Monthly or Yearly (match the table)
   - **Description:** one sentence, e.g. `Lazynext Team plan — unlimited members, nodes, workflows. 100 AI queries/seat/day. Billed monthly.`
...
| Product | Save URL as |
|---|---|
| Team Monthly ($12) | `STARTER_MONTHLY_URL` |
| Team Yearly ($120) | `STARTER_ANNUAL_URL` |
| Business Monthly ($24) | `PRO_MONTHLY_URL` |
| Business Yearly ($240) | `PRO_ANNUAL_URL` |
