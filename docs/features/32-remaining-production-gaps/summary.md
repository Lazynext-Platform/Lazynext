...
- **Gap #3 — Generative fill**: Replaced HTTP 501 stub with Replicate API + OpenCV inpainting fallback
- **Gap #4 — Avatar dubbing**: Wired `avatar-prompt.tsx` to real ElevenLabs TTS API
...
- `services/generative-studio/src/` — Replicate API generative fill path
- `services/ai-agents/src/` — ElevenLabs TTS integration
