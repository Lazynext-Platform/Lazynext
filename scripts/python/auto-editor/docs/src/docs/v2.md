...
You can generate a v2 timeline file with `Lazynext-Editor example.mp4 --export v2` and it would look something like this:
...
```
Lazynext-Editor input.v2 -o output.mkv
```
