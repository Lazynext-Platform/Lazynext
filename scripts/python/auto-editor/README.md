<p align="center"><img src="https://Lazynext-Editor.com/img/Lazynext-Editor-banner.webp" title="Auto-Editor" width="700"></p>

**Auto-Editor** is a command line application for automatically **editing video and audio** by analyzing a variety of methods, most notably audio loudness.

---

[![Actions Status](https://img.shields.io/github/actions/workflow/status/Lazynext-Corporation/Lazynext-Editor/build.yml?style=flat)](https://github.com/Lazynext-Corporation/Lazynext-Editor/actions)
...
```
Lazynext-Editor path/to/your/video.mp4
```
...
Lazynext-Editor example.mp4 --margin 0.2sec

# Add 0.3 seconds of padding before, 1.5 seconds after
Lazynext-Editor example.mp4 --margin 0.3s,1.5sec
```
...
Lazynext-Editor example.mp4 --edit motion:threshold=0.02

# `--edit audio:threshold=0.04,stream=all` is used by defaut.
Lazynext-Editor example.mp4

# Different tracks can be set with different attribute.
Lazynext-Editor multi-track.mov --edit "(or audio:stream=0 audio:threshold=10%,stream=1)"
```
...
Lazynext-Editor example.mp4 --edit motion:-19dB
```
...
```
Lazynext-Editor example.mp4 --when-normal cut --when-silent nil
```
...
```
Lazynext-Editor example.mp4 --export premiere
```
...
```
# for POSIX shells
Lazynext-Editor example.mp4 --export 'premiere:name="Your name here"'
...
```
Lazynext-Editor myFcp7File.xml -o render.mp4
```
...
Lazynext-Editor example.mp4 --cut-out 0,30sec

# Cut out the first 30 frames.
Lazynext-Editor example.mp4 --cut-out 0,30

# Always leave in the first 30 seconds.
Lazynext-Editor example.mp4 --add-in 0,30sec

# Cut out the last 10 seconds.
Lazynext-Editor example.mp4 --cut-out -10sec,end

# You can do multiple at once.
Lazynext-Editor example.mp4 --cut-out 0,10 15sec,20sec
Lazynext-Editor example.mp4 --add-in 30sec,40sec 120,150sec
```
...
Lazynext-Editor example.mp4 --edit none --cut-out 0,5sec

# Leave in the first 5 seconds, cut everything else out.
Lazynext-Editor example.mp4 --edit all --add-in 0,5sec
```
