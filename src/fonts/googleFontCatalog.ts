...
export const GOOGLE_FONT_CATALOG: readonly GoogleFontCatalogEntry[] = [
  ...
  { family: 'LXGW WenKai TC', aliases: ['LXGW WenKai'], loadable: true, source: 'google' },
  ...
  { family: 'ZCOOL QingKe HuangYou', aliases: ['ZCOOL QingKe HuangYou (Chinese display font)'], loadable: true, source: 'google' },
];
