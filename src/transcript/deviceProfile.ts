...
/**
 * Backend + model tier. Users explicit setting (settings → → Default model,
 ...
 * NOTE: onnxruntime-webs webgpu EP produces hallucinated output for these
...
export function chooseAsrConfig(profile: DeviceProfile): AsrConfig {
 ...
 // WebGPU is an explicit opt-in (settings → → WebGPU accelerated) and only
