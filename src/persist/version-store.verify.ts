// Runnable check: `npx tsx src/persist/version-store.check.ts` verify:persist pretest row
...
mem.set('versions:p3', [
 { id: 'ok', name: '', createdAt: 1, doc },
 { id: 'bad1', createdAt: 2, doc }, // missing name
 { id: 'bad2', name: '', createdAt: 3, doc: { nope: true } }, // fails migrateProjectDoc
 'not-even-an-object',
]);
