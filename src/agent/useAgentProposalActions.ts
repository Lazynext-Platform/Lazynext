...
function commitAppliedUi(
 ...
 role: 'user',
 content: `Applied${chosen.length}/${proposal.options[0].operations.length} operations`,
 });
...
async function persistSelectedProposal(
 ...
 await persistence.saveVersion(projectId, 'Agent ', currentDoc);
