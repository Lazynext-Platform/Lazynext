...
import { executeLazynextTool, type CodexToolExecution } from './codex/runtime';
...
async function executeWithRecorder(
  ...
  return executeLazynextTool(aspectSchema, { ratio: '9:16' }, {
...
async function executeInstallSkill(
  ...
  return executeLazynextTool(installSkillSchema, { repo: 'owner/skill' }, {
...
async function verifyAbortFence(): Promise<void> {
  ...
  const pending = executeLazynextTool(aspectSchema, { ratio: '9:16' }, {
...
async function verifyYoloSkipsAllGuards(): Promise<void> {
  ...
  const execution = await executeLazynextTool(aspectSchema, { ratio: '9:16' }, {
