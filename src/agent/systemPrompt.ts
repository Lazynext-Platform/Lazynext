...
export function agentLanguagePrompt(_locale?: Locale): string {
  return `\n\n# Response Language\nThe interface language is English. Write all user-facing responses, questions, summaries, and generated editing instructions in English.`;
}
...
# Product identity
- The official product name is Lazynext. Use Lazynext in user-facing self-introductions, help, navigation guidance, and descriptions of the current application.
...
export const SYSTEM_PROMPT = `You are Lazynext's professional writer-director and video-editing AI. Edit the user's project by calling tools.
