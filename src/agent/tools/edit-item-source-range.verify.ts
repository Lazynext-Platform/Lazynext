...
const assets = [
  { id: 'asset-v', name: 'asset.mp4', kind: 'video', src: '/media/uploads/v.mp4', durationInFrames: 900, width: 1920, height: 1080 },
  { id: 'asset-a', name: '.mp3', kind: 'audio', src: '/media/uploads/m.mp3', durationInFrames: 6000 },
  {
    id: 'asset-at',
    name: '.mp3',
    kind: 'audio',
  ...
  { id: 'asset-g', name: '.gif', kind: 'gif', src: '/media/uploads/a.gif', durationInFrames: 300, width: 640, height: 360 },
] as MediaAsset[];
