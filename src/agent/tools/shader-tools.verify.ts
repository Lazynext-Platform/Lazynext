...
const props = buildProps([
 { key: 'amount', label: '', default: 5, min: 0, max: 2 }, // default out of range → clamped in
...
const tdef = buildCustomTransitionDef('Swirl Wipe', VALID_TR, [{ key: 'swirl', label: '', default: 0.7, min: 0, max: 1 }]);
...
// ── normalizeShaderArgs: prompt + name + type ──
{
