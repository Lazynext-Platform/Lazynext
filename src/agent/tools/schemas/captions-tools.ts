...
export const CAPTIONS_TOOL_SCHEMAS: AgentToolSchema[] = [
  ...
  },
  {
    ...
    description:
      ...
      "- hide_overlay / show_overlay: global captionsHidden flag (toolbar Captions) — hides on-screen caption overlay and text clips without wiping caption data; show_overlay re-enables.\n" +
