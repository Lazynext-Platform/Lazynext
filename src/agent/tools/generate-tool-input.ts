...
export function buildSubmitImageArgs(args: GenerateArgs): SubmitImageArgs {
  ...
  if (model === 'wavespeed' || model === 'byteplus' || model === 'pollinations' || model === 'vertex-imagen') return { ...shared, imageSize: args.imageSize as SubmitImageArgs['imageSize'], width, height };
