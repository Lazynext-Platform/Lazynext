...
If you violate any pattern, the symptom is consistent: the affected motion graphic appears entirely black or empty in local export, even though preview in Lazynext and a normal browser both look correct. Preview rendering correctly is NOT evidence that export will work.
