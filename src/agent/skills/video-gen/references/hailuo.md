...
Grounded in Lazynext’s video adapter (`server/plugins/video.ts` → MiniMax
...
`MiniMax-Hailuo-2.3` / `MiniMax-Hailuo-2.3-Fast`). Call it **Hailuo / Hailuo /
...
- User named **MiniMax / Hailuo / Hailuo**
