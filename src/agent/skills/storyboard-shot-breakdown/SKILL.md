...
3. Detect or mark shot boundaries with available Lazynext/media tooling.
...
- Prefer current Lazynext/media tools over hardcoded local commands. Use external scripts only when they are available and clearly help.