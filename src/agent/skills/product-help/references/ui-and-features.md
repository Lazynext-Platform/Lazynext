...
- **My Assets** (ZH: "My Assets") — The user's media pool. Shows uploaded, recorded, imported, and generated media. Users can drag assets from here onto the timeline. The **Upload** button opens local file / folder import.
...
- **Transcript** (ZH: "Transcript" / ES: "Transcripción") — A text-based editing panel for talking head / interview footage. Users edit the video by editing text:
