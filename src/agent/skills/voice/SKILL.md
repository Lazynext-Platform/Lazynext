...
- The curated catalog in [references/voices.md](references/voices.md) covers
  ...
  or sample catalog in Lazynext. Require a concrete voice ID from the user or
...
submit_voice({
  ...
  emotion: "sad",
  emotionScale: 3,
  performancePrompt: "Pained but restrained, slightly slower pace, like a news feature narration",
  pitch: -1,
  speedRatio: 0.92,
});
...
separate providers with curated Lazynext choices from providers that require
...
For a provider without a curated Lazynext catalog, ask for a free-text,
...
<widget submit_label="Submit">
  <form-visual
    id="voiceId"
    label="I recommend these Chinese narration voices — listen first:"
    required="true"
  >
    <visual-option
      value="morgan"
      ...
      aspect-ratio="16:5"
      summary="Male / middle-aged / deep knowledge narration"
    />
    <visual-option
      value="zhixingnv"
      name="Knowledgeable Female"
      media="/voice-samples/doubao-zhixingnv.mp3"
      aspect-ratio="16:5"
      summary="Female / middle-aged / calm knowledge narration"
    />
    <visual-option
      value="vivi"
      name="Vivi"
      media="/voice-samples/doubao-vivi.mp3"
      aspect-ratio="16:5"
      summary="Female / young / friendly general narration"
    />
  </form-visual>
</widget>
```
...
confirmed by the user and have no bundled Lazynext samples.
