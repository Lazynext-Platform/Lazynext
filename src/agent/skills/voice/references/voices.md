...
Lazynext preset/sample catalog. For those providers, require a concrete
...
| `naiqimengwa`        | Childlike Boy    | Childlike Boy        | male, child, cute, storybook, character                        | Cute boy character lines and children's stories               |
| `yingtaowanzi`       | Cherry Voice     | Cherry Voice         | female, child, cartoon, roleplay, character                    | Animated/kid-oriented character dialogue                      |
| `wenroumama`         | Warm Mom         | Warm Mom             | female, middle-aged, warm, family, gentle                      | Family, lifestyle, parenting, gentle explanations             |
| `zhixingnv`          | Knowledgeable Female | Knowledgeable Female | female, middle-aged, calm, knowledge, explainer                | Education, culture, thoughtful explainers                     |
| `dayi`               | Dayi             | Dayi                 | male, young, steady, formal, documentary, video-voiceover      | Formal voiceover, documentary, corporate narration            |
| `jitangnv`           | Inspirational Female | Inspirational Female | female, young, warm, inspirational, emotional, video-voiceover | Motivational, uplifting, emotional video narration            |
| `liuchang`           | Smooth Female    | Smooth Female        | female, young, smooth, polished, video-voiceover, narration    | Clean product narration and polished video voiceover          |
| `ruyayichen`         | Yichen           | Yichen               | male, young, elegant, premium, culture, video-voiceover        | Cultural, premium, poetic, documentary-style narration        |
...
| `huiben`             | Storybook Voice  | Storybook Voice      | female, young, gentle, storybook, audiobook                    | Gentle storybook or bedtime-style narration                   |
| `popo`               | Grandma          | Grandma              | female, old, warm, story, character                            | Grandmother characters, folk stories, nostalgic narration     |
| `yuanboxiaoshu`      | Erudite Uncle    | Erudite Uncle        | male, middle-aged, knowledge, calm, explainer                  | Calm explainers, cultural commentary, educational narration   |
| `baqiqingshu`        | Confident Uncle  | Confident Uncle      | male, middle-aged, confident, audiobook, narrative             | Audiobook narration, long-form stories, dramatic reads        |
| `shuanglangshaonian` | Cheerful Teen    | Cheerful Teen        | male, young, cheerful, youthful, roleplay, character           | Bright roleplay, teen/creator dialogue, youthful scenes       |
