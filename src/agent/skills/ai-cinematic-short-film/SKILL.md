...
Use this workflow when the user wants Lazynext to create a cinematic AI-generated short film or story-led visual sequence.

This is a Lazynext-native workflow. If a source workflow depends on external image/video generation or manual assembly, replace that step with Lazynext's equivalent capability when available. Do not add unrelated Lazynext features just because they exist.
...
- Replace external generation or assembly steps with equivalent Lazynext capabilities when they exist. Do not introduce unrelated Lazynext features just because they are available.
