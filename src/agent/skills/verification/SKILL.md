---
name: verification
description: Use when checking whether agent edits are reflected in the Lazynext project and editor.
---
...
Use `view_timeline_frames` for composed timeline proof. This verifies the edited Lazynext timeline: trims, layers, captions, effects,
...
If both visual proof paths are blocked, ask the user to inspect the Lazynext
