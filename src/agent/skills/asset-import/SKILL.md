...
For multi-source edits, build reviewable work from original source assets in the Lazynext timeline. Do not locally concatenate, pre-trim, pre-compose, burn captions, or flatten media before import — import originals and do all composition on the timeline so every step stays reviewable and undoable.
