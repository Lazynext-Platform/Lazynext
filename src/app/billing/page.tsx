    ...
    <div className="min-h-screen bg-neutral-950 text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-neutral-900/50 backdrop-blur-xl border border-neutral-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <p className="text-neutral-400 mb-8 relative z-10">
          Unlock the full power of the AI autonomous NLE. Render in 4K, collaborate with infinite teammates, and access the Visionary AI Agent.
        </p>
        ...
        <button
          ...
          disabled={loading}
          className="w-full relative z-10 bg-cyan-500 hover:bg-cyan-400 text-neutral-950 font-semibold py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(6,182,212,0.3)] hover:shadow-[0_0_30px_rgba(6,182,212,0.5)] disabled:opacity-50"
        >
