...
//
// The RMS reference uses the recordings high-decile level plus an absolute
...
export interface SilenceParams {
 /** Silence threshold relative to the recordings RMS reference (dB, default -26; more negative = more conservative) */
 thresholdDb?: number;
