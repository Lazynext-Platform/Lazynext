...
assert.equal(loadTimelineViewState(storage, 'project-a', 'timeline-a'), null, 'none timeline must fit/defaultinherit timeline');
...
console.log('timelineViewState.verify: ok (timelineId //partial merge/)');
