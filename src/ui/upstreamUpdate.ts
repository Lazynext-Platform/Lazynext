...
export const UPSTREAM_LATEST_RELEASE_URL = 'https://api.github.com/repos/lazynext/Lazynext/releases/latest';
export const UPSTREAM_RELEASES_URL = 'https://github.com/lazynext/Lazynext/releases/latest';
...
type DesktopUpdateApi = NonNullable<Window['lazynextDesktop']>['updates'];
...
function desktopUpdateApi(): DesktopUpdateApi | null {
  ...
  return window.lazynextDesktop?.updates ?? null;
}
