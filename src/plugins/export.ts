...
// MG/zoom on timeline - packaged as lazynext-plugin@1 JSON. Pure function, data is injected by the caller
...
export function transitionCandidates(defs: CustomTransitionDef[], transitions: TransitionItem[]): ExportCandidate[] {
 ...
 const name = t.customLabel ?? 'Custom';
