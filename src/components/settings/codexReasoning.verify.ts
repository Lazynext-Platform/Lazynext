...
const modelField: SettingsField = {
  name: 'CODEX_MODEL', label: 'Codex', kind: 'text',
  defaultLabel: 'Codex default', discoverableModel: true,
};
const effortField: SettingsField = {
  name: 'CODEX_REASONING_EFFORT', label: '', kind: 'select',
};
...
const apiModelField: SettingsField = {
  name: 'LLM_MODEL', label: 'Agent', kind: 'text', discoverableModel: true,
};
assert.equal(
