...
export const localAsrPage = transcriptionPage('local', 'localasr', 'Local model (Whisper)', [
 ...
 note: 'Downloaded ≥6GB Small Base',
 options: [
...
], 'WebGPU Unavailable CPULocal transcriptionSpeaker diarization');
...
export const VOICE_SETTINGS_GROUP: SettingsGroup = {
 ...
 modelText('DOUBAO_TTS_RESOURCE_ID', 'Asset ID', 'seed-tts-2.0'),
 ],
 },
 {
 ...
 text('INWORLD_TTS_BASE_URL', 'Base URL', ' https://api.inworld.ai'),
 ...
 text('FISHAUDIO_TTS_BASE_URL', 'Base URL', ' https://api.fish.audio'),
 ...
 text('SPEECHIFY_TTS_BASE_URL', 'Base URL', ' https://api.sws.speechify.com'),
