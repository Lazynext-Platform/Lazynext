...
export function useTimelineController({
 ...
 // playhead / marker placement can follow the media elements own clock during
 ...
 return [{ ...base, id: `caption:${captionSelectionKey(captionSelection) ?? base.id}`, name: `${cue.text}` }];
 }),
 ];
