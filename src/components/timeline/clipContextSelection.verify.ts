...
const items = [
  { id: 'caption-card', name: 'title', kind: 'motion-graphic', track: 'V2', startFrame: 0, durationInFrames: 60 },
  { id: 'video-main', name: 'video', kind: 'video', track: 'V1', startFrame: 0, durationInFrames: 120 },
  { id: 'audio-bed', name: 'background', kind: 'audio', track: 'A1', startFrame: 0, durationInFrames: 120 },
] as TimelineItem[];
