...
const textItem = {
  ...base,
  kind: 'text',
  props: { text: '', fontSize: 96, color: '#ff0000', fontWeight: 700, align: 'center' },
} as TimelineItem;
...
const mgItem = {
  ...base,
  kind: 'motion-graphic',
  props: { title: '', textColor: '#00ff00', fontSize: 64 },
  code: 'const X = () => null;',
} as TimelineItem;
