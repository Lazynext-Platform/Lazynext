...
export const EMPTY_PROJECT_STARTERS: readonly ProjectStarter[] = [
 ...
 { label: 'Motion package', description: 'Titles, info cards, and transitions', prompt: 'Motion package', icon: 'film' },
 ...
 { label: 'AI visual', description: 'Develop shots and sound from a concept', prompt: ' AI visual', icon: 'image' },
