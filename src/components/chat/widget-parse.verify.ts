...
const base = 'https://lazynext.local/editor';

assert.equal(safeWidgetMediaUrl('/media/preview.png', base), 'https://lazynext.local/media/preview.png');
assert.equal(safeWidgetMediaUrl('voice/sample.mp3', base), 'https://lazynext.local/voice/sample.mp3');
assert.equal(safeWidgetMediaUrl('blob:https://lazynext.local/id', base), 'blob:https://lazynext.local/id');
