...
// `props` carry each uniforms defaults/ranges and drive both the
...
export const FX_EFFECTS: Record<string, FxDef> = {
 ...
 name: '',
 desc: 'lift gamma gain 0.5 ',
 frag: colorWheelsFrag,
 props: [
 { key: 'liftColor', label: ' Lift', kind: 'color', default: [0.5, 0.5, 0.5], uniform: 'u_liftColor' },
 { key: 'gammaColor', label: ' Gamma', kind: 'color', default: [0.5, 0.5, 0.5], uniform: 'u_gammaColor' },
 { key: 'gainColor', label: ' Gain', kind: 'color', default: [0.5, 0.5, 0.5], uniform: 'u_gainColor' },
 ...
 name: 'Levels',
 desc: '/ + Gamma + / inspect_color ',
 frag: levelsFrag,
 props: [
 { key: 'inBlack', label: '', default: 0, min: 0, max: 0.5, step: 0.005 },
 { key: 'inWhite', label: '', default: 1, min: 0.5, max: 1, step: 0.005 },
 { key: 'gamma', label: 'Gamma', default: 1, min: 0.2, max: 3, step: 0.02 },
 { key: 'outBlack', label: '', default: 0, min: 0, max: 0.5, step: 0.005 },
 { key: 'outWhite', label: '', default: 1, min: 0.5, max: 1, step: 0.005 },
 ],
 },
 ...
 props: [
 { key: 'shadows', label: '', default: 0, min: -1, max: 1, step: 0.02 },
 { key: 'highlights', label: '', default: 0, min: -1, max: 1, step: 0.02 },
 { key: 'shadowRange', label: '', default: 0.35, min: 0.1, max: 0.7, step: 0.01 },
 { key: 'highlightRange', label: '', default: 0.35, min: 0.1, max: 0.7, step: 0.01 },
 ],
 },
 'builtin:fx-clarity': {
 ...
 { key: 'radius', label: '(px)', default: 24, min: 4, max: 64, step: 1 },
 ],
 },
 ...
 frag: hslQualifyFrag,
 props: [
 { key: 'hueCenter', label: '(°)', default: 25, min: 0, max: 360, step: 1 },
 { key: 'hueWidth', label: '(°)', default: 25, min: 5, max: 90, step: 1 },
 { key: 'softness', label: '(°)', default: 20, min: 1, max: 60, step: 1 },
 { key: 'hueShift', label: '(°)', default: 0, min: -60, max: 60, step: 1 },
 { key: 'satMul', label: 'Saturation×', default: 1, min: 0, max: 2, step: 0.02 },
 { key: 'lumaMul', label: '×', default: 1, min: 0.5, max: 1.5, step: 0.01 },
 ],
 },
...
export const LUT_EFFECTS: Record<string, FxDef> = {
 ...
 desc: 'Sony S-Log3 / S-Gamut3.Cine → Rec.709.cube Sony_Slog3_s709.cube, 33³+ lut.fragsampler3DBT.709 ',
 frag: lutFrag,
 ...
 desc: 'Canon Cinema Gamut / Canon Log 3 → Canon 709.cube CinemaGamut_CanonLog3-to-Canon709_33_Ver.1.0.cube, 33³+ lut.frag',
 frag: lutFrag,
...
// ── Runtime custom fx (submit_shaders LLM generated product) registry ──────────────────────
