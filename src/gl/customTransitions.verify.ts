...
const def = {
  ...
  props: [{ key: 'swirl', label: '', default: 0.7, min: 0, max: 1, step: 0.01 }],
};
...
const custom = reduce(base, { type: 'addTransition', id: 'tr1', incomingItemId: 'b', transType: 'custom-shader', durationInFrames: 20, custom: { frag: 'FRAG_SRC', uniforms: { u_swirl: 0.7 }, label: 'transition' } });
...
assert.equal(tr.customLabel, 'transition');
