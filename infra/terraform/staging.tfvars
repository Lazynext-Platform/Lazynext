...
# ── API Keys (placeholder — replace with real keys after staging testing) ───
openai_api_key        = "sk-placeholder-openai-key-for-staging"
anthropic_api_key     = "sk-ant-placeholder-anthropic-key-for-staging"
